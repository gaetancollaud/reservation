...
export class ReservationSearchComponent extends SubscriptionHelper implements OnInit, OnDestroy {
    ...
    ngOnInit() {
        ...
        this.addSubscription(
            this.datastore.search.pipe(distinctUntilChanged()).subscribe((search: ReservationCriteria) => {
        ...
        this.addSubscription(
            this.formGroup.valueChanges.subscribe((value: ReservationCriteria) => {
