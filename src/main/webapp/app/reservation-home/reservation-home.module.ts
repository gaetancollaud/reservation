...
import { UserReservationDialogComponent, UserReservationPopupComponent } from './reservation-operation/user-reservation-dialog.component';
...
@NgModule({
    ...
    entryComponents: [ReservationHomeComponent, UserReservationDeleteDialogComponent, UserReservationDialogComponent],
    providers: [ReservationHomeDatastoreService, UserReservationPopupService],
