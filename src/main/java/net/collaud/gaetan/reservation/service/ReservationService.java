...
public class ReservationService {
    ...
    protected void checkConflict(Reservation reservation) {
        long inConflict = reservationRepository.search(new ReservationCriteria(
        ...
        if (inConflict + 1 > resource.getType().getMaxResource()) {
            throw new ReservationConflictException("Conflict found with " + inConflict + " reservation(s)");
        }
    }
